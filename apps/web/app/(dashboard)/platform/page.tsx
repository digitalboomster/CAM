...
const MODULES = [
  ...
  { id: "oms", name: "Intelligent Order Management", description: "Aggregate orders across funds for institutional pricing. NGX and FMDQ.", href: "/oms", status: "live" as const },
  { id: "deal-sourcing", name: "Deal Sourcing", description: "AI-powered search, ranked targets, market multiples.", href: "/deal-sourcing", status: "live" as const },
  { id: "market-intel", name: "Market Intelligence", description: "Research console, news + AI summaries, competitor monitoring.", href: "/market-intelligence", status: "live" as const },
  { id: "docuflow", name: "DocuFlow", description: "Templates, data mapping, AI writing assistant.", href: "/docuflow", status: "live" as const },
  { id: "valuation", name: "Valuation", description: "Deal, model inputs, comps, DCF, AI Co-Pilot.", href: "/valuation", status: "live" as const },
  { id: "regulator", name: "Regulator Reporting", description: "SEC/compliance templates, export history.", href: "/regulator-reporting", status: "live" as const },
];
